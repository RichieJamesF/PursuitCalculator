...
// Exported so routes/strava.js can size the nonce cookie's maxAge to match exactly —
// two independent "15 minutes" constants would drift silently.
export const STATE_EXPIRY_MINUTES = 15;
